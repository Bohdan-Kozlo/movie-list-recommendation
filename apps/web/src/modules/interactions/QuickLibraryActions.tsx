...
export function QuickLibraryActions({ titleId }: QuickLibraryActionsProps) {
  ...
  return (
    <div className="absolute inset-x-0 top-0 flex items-start justify-between p-2.5">
      <p className="rounded-full bg-[#122231]/90 px-2 py-1 font-mono text-[10px] font-bold uppercase tracking-[.08em] text-[#edf4f7] shadow-sm backdrop-blur-sm" aria-live="polite">
        {message ?? 'Quick save'}
      </p>
